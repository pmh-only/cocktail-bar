locals {
  bastion_sg_name       = "${var.project_name}-sg-instance"
  bastion_key_name      = "${var.project_name}-keypair-instance"
  bastion_role_name     = "${var.project_name}-role-instance"
  bastion_instance_name = "${var.project_name}-instance"
  bastion_ip_name       = "${var.project_name}-instance"
