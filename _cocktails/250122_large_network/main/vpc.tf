locals {
  ...
  subnet_patterns = {
    public  = { start_index = 1, count_per_az = 1 },
    private = { start_index = 3, count_per_az = 1 },
    intra   = { start_index = 5, count_per_az = 1 }
  }
  ...
  name_formats = {
    subnet = {
      public  = "$1-Public-Subnet$2",    # Example: project-subnet-public-a
      private = "$1-Appliance-Subnet$2", # Example: project-subnet-private-a
      intra   = "$1-TransitGW-Subnet$2"  # Example: project-subnet-protected-a
    },
    route_table = {
      public  = "$1-rtb-public",       # Example: project-rtb-public-a
      private = "$1-rtb-appliance-$2", # Example: project-rtb-private-a
      intra   = "$1-rtb-transitgw",    # Example: project-rtb-protected-a
...
locals {
  # Determine final AZs
  valid_azs   = [for az in data.aws_availability_zones.available.names : az if !strcontains(az, "wlz") && !strcontains(az, "atl")]
