module "ecs_service_stress" {
  ...
  container_definitions = {
    ...
    log_router = {
      ...
      environment = [
        {
          ...
          value = base64encode(<<-EOF
            ...
            [OUTPUT]
              ...
              log_group_name /wsi/webapp/stress
      ...
      log_configuration = {
        logDriver = "awslogs"
        options = {
          awslogs-group         = "/ecs/${var.project_name}-cluster/stress-logroute"
  ...
  load_balancer = {
    service = {
      target_group_arn = module.alb.target_groups.stresstg1.arn
