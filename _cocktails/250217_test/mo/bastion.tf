locals {
  bastion_sg_name       = "wsc2024-bastion-sg"
  bastion_key_name      = "wsc2024-keypair"
  bastion_role_name     = "wsc2024-bastion-role"
  bastion_instance_name = "wsc2024-bastion-ec2"
  bastion_ip_name       = "wsc2024-bastion"
