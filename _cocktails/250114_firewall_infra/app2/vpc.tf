locals {
  ...
  vpc_name = "${var.project_name}-vpc-app2"
  ...
  name_formats = {
    subnet = {
      ...
      intra   = "$1-subnet-app2-protected-$2" # Example: project-subnet-protected-a
    },
    route_table = {
      public  = "$1-rtb-public-$2",         # Example: project-rtb-public-a
      private = "$1-rtb-private-$2",        # Example: project-rtb-private-a
      intra   = "$1-rtb-app2-protected-$2", # Example: project-rtb-protected-a
      default = "$1-rtb-app2-default"       # Example: project-rtb-default
    },
    nat_gateway = "$1-app2-natgw-$2", # Example: project-natgw-a
    igw         = "$1-app2-igw"       # Example: project-igw
  }
}
