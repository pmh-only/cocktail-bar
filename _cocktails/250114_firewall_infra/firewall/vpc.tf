locals {
  ...
  vpc_name = "${var.project_name}-vpc-firewall"
  ...
  name_formats = {
    subnet = {
      ...
      intra   = "$1-subnet-firewall-protected-$2" # Example: project-subnet-protected-a
    },
    route_table = {
      public  = "$1-rtb-public-$2",             # Example: project-rtb-public-a
      private = "$1-rtb-private-$2",            # Example: project-rtb-private-a
      intra   = "$1-rtb-firewall-protected-$2", # Example: project-rtb-protected-a
      default = "$1-rtb-firewall-default"       # Example: project-rtb-default
    },
    nat_gateway = "$1-firewall-natgw-$2", # Example: project-natgw-a
    igw         = "$1-firewall-igw"       # Example: project-igw
  }
}
